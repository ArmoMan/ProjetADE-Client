...
from communication.socketio_client import SocketIOClient
...
class ApplicationControleur(ObservateurCommandes):
    ...
    def __init__(self, capteurs_choisis: list[CapteursParent], url: str, cle_api: str):
        ...
        # le socketio connexion
        self.__ws = SocketIOClient(url, cle_api)
    ...
    def sur_commande_recu(self, commande:dict):
        ...
        if command_valeur in self.__gestionnaire_commandes:
            return self.__gestionnaire_commandes[command_valeur](commande)
        
        # si commande pas trouvé ou sans reponse
        return None
    ...
    def __envoyer_donnees(self, commande):
        ...
        return self.__donees_pour_envoyer
